export default () => {
    return <>
        <div className="dark:text-gray-300 text-gray-700 bg-gray-100 dark:bg-gray-900 p-8">
            ...
            <p className="mb-4">We collect information that you provide directly to us. The types of personal information we may collect include your name, email address, and any other information you choose to provide.</p>
            ...
            <ul className="list-disc pl-6 mb-4">
                ...
                <li>To send you emails, newsletters, and other communications.</li>
                <li>To comply with legal obligations.</li>
            </ul>

            <h2 className="text-xl font-semibold mb-2">3. How We Share Your Information</h2>

            <p className="mb-4">We may share your information with third parties only in the ways that are described in this Privacy Policy. We may disclose your personal information in the following circumstances:</p>
            <ul className="list-disc pl-6 mb-4">
                <li>With your consent.</li>
                <li>To comply with applicable laws and regulations.</li>
                <li>To respond to a subpoena, search warrant, or other lawful request for information we receive, or to otherwise protect our rights.</li>
            </ul>

            <h2 className="text-xl font-semibold mb-2">4. Your Rights</h2>

            <p className="mb-4">You have the right to access personal information we hold about you and to ask that your personal information be corrected, updated, or deleted. If you would like to exercise this right, please contact us at <a href="mailto:privacy@bikoret.io" className="text-blue-500 hover:underline">privacy@bikoret.io</a>.</p>
            ...
            <p className="mb-4">If you have any questions about this Privacy Policy, please contact us at <a href="mailto:privacy@bikoret.io" className="text-blue-500 hover:underline">privacy@bikoret.io</a>.</p>
